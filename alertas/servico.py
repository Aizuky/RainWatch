...
def _enviar_email(destinatario: str, mensagem: str, bairro: str) -> tuple[bool, str]:
    ...
    try:
        ...
        # send_mail(
        #     subject=f"Rainwatch — Alerta {bairro}",
        #     message=mensagem,
        #     from_email="alertas@rainwatch.recife.br",
...
def processar_sensores(sensores: list[dict]) -> list[Alerta]:
    """
    Recebe a lista de sensores, gera e envia alertas para cada sensor
    em nível 'alerta' ou 'critico' conforme as ConfiguracaoAlerta ativas.
    Retorna a lista de Alertas criados nesta rodada.
    """
